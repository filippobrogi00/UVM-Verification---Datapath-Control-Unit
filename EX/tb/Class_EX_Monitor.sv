  ...
  * */
  virtual task run_phase(uvm_phase phase);
    ...
    forever begin
      ...
      Class_EXE_SequenceItem exe_seqitem = Class_EXE_SequenceItem::type_id::create(
          "exe_seqitem", this
      );
      ...
      // Outputs
      exe_seqitem.DRAM_Addr			= exe_dut_iface.DRAM_Addr;
      exe_seqitem.DRAM_DATA			= exe_dut_iface.DRAM_DATA;
      ...
      exe_seqitem.S3_BranchTaken	= exe_dut_iface.S3_BranchTaken;
      exe_seqitem.S3_MUX_A_OUT		= exe_dut_iface.S3_MUX_A_OUT;
      exe_seqitem.S3_MUX_B_OUT		= exe_dut_iface.S3_MUX_B_OUT;
      exe_seqitem.S3_ALU_OUT		= exe_dut_iface.S3_ALU_OUT;
      exe_seqitem.S3_MUX_JMP_OUT	= exe_dut_iface.S3_MUX_JMP_OUT;
