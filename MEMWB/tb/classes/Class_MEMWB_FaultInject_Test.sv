...
class Class_MEMWB_FaultInject_Test extends uvm_test;
  int fault_fd;
  int log_fd;
  int stuckat;
  string signal_name;
  ...
  // Register to Factory
  `uvm_component_utils(Class_MEMWB_FaultInject_Test);

  // Constructor
  function new(string name = "Class_MEMWB_FaultInject_Test", uvm_component parent = null);
    ...
    while (!$feof(fault_fd)) begin
      ...
      fork
        ...
        begin
          ...
          memwb_environment.memwb_agent.memwb_sequencer.stop_sequences();
