...
end sign_extender26_32;

architecture BEH_COMB_sign_extender_26_32 of sign_extender26_32 is 
...
begin
	...
	GEN_SIGNALS: FOR i IN 0 to IR_SIZE-1 GENERATE
		...
		UpperBits: IF i >= N-1 GENERATE
			IMM_OUT(i) <= IMM_IN(N-1); 
		END GENERATE UpperBits;	
    END GENERATE GEN_SIGNALS; 

end BEH_COMB_sign_extender_26_32;
