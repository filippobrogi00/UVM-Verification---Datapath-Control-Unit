...
#analyze -f vhdl -lib WORK ../src/a.c-IRAM.vhd
analyze -f vhdl -lib WORK ../src/a.b-DP-MEMWB.vhd

# To preserve rtl names in the netlist to ease the procedure for power consumption estimation
set power_preserve_rtl_hier_names true

elaborate DP_MEMWB -lib WORK
...
write_sdf ./DP_MEMWB.sdf

# Saving the Synopsys Design Constraints
write_sdc ./DP_MEMWB.sdc

# Saving the verilog netlist
write -f verilog -hierarchy -output ./DP_MEMWB.v
